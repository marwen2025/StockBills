...
const ModalAdd = ({ isVisible, onClose }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        const clientId = selectedClient ? selectedClient.value : null;
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                toast.error("Check entered details ");
            }
        } catch (response) {
                    ...
                    <div className="px-6 py-6 lg:px-8">
                        ...
                        <form onSubmit={handleSubmit} className='min-w-[500PX] '>
                            <div className='mb-'>
                                ...
                                <Select
                                    options={clients.map((client) => ({ value: client._id, label: `${client.name} ${client.firstname} ${client._id}` }))}
                            ...
                            {lineItems.map((lineItem, index) => (
                                <div key={index} className='mb-2 gap-6 mt-2 grid grid-cols-2'>
                                    ...
                                    <div className='mb-2 justify-between mt-2 flex'>
                                        ...
                                        <button className='mt-6' type="button" onClick={() => removeLineItem(index)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="35px" height="25px" viewBox="0 0 24 24">
                                                <g>
